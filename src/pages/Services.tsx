            ...
            <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
                {serviceList.map((service, i) => (
                    <ScrollAnimation key={i} delay={i * 0.1}>
                        <Card className={`flex flex-col border-white/10 bg-black/40 backdrop-blur-sm transition-all hover:bg-black/60 ${service.flagship ? 'border-orange-500/50 shadow-[0_0_30px_-10px_rgba(249,115,22,0.3)]' : ''}`}>
                            <CardHeader>
